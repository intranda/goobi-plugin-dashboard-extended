...
Dieses Dashboard Plugin ermöglicht durch eine detaillierte Darstellung einen verbesserten Überblick. Es können
beispielsweise die zuletzt bearbeiteten Aufgaben oder relevante Statistiken angezeigt werden.
...
Für eine Nutzung dieses Plugins muss der Nutzer innerhalb der Einstellungen für das Dashboard den Wert
`intranda_dashboard_extended` auswählen.

![Auswahl des Dashboards in den Nutzereinstellungen](screen1_de.png)

## Überblick und Funktionsweise

Wenn das Plugin korrekt installiert ist und Nutzer sich dieses als Dashboard eingestellt haben, ist es nach dem Login in
Goobi workflow anstelle der Startseite sichtbar.
...
--------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 `<nagios-show>`                            | Dieser Parameter legt fest, ob das Nagios Monitoring angezeigt werden soll.                                                                                                                                                                                    
 `<nagios-host>`                            | Dieser Parameter legt den Host fest, der vom Nagios Monitoring angezeigt werden soll.                                                                                                                                                                          
 `<nagios-login>`                           | Dieser Parameter legt den Benutzernamen fest, mit dem der Login beim Monitoring Server erfolgen soll.                                                                                                                                                          
 `<nagios-password>`                        | Dieser Parameter legt das Passwort fest, mit dem der Login beim Monitoring Server erfolgen soll.                                                                                                                                                               
 `<icinga2-show>`                           | Dieser Parameter legt fest, ob das Icinga2 Monitoring angezeigt werden soll.                                                                                                                                                                                   
 `<icinga2-host>`                           | Dieser Parameter legt den Icinga2 Monitoring Server Host fest, von dem die Monitoring Informationen kommen sollen.                                                                                                                                             
 `<icinga2-username>`                       | Dieser Parameter legt den Benutzernamen fest, mit dem der Login beim Monitoring Server erfolgen soll.                                                                                                                                                          
 `<icinga2-password>`                       | Dieser Parameter legt das Passwort fest, mit dem der Login beim Monitoring Server erfolgen soll.                                                                                                                                                               
 `<rss-show>`                               | Dieser Parameter legt fest, ob Neuigkeiten angezeigt werden sollen, die per RSS-Feed abgefragt werden können.                                                                                                                                                  
 `<rss-url>`                                | Dieser Parameter legt fest, von welcher Webseite der RSS-Feed geladen werden soll.                                                                                                                                                                              
