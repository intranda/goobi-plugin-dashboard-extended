...
This dashboard plugin provides an improved overview through detailed display options. For example, the most recently
edited tasks or relevant statistics can be shown.
...
If the plugin is installed correctly and users have set it as their dashboard, it will be visible after logging into
Goobi workflow instead of the start page.
...
--------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 `<nagios-show>`                            | This parameter defines whether Nagios monitoring should be displayed.                                                                                                                                               
 `<nagios-host>`                            | This parameter specifies the host that should be displayed by the Nagios monitoring.                                                                                                                                
 `<nagios-login>`                           | This parameter defines the username used to log in to the monitoring server.                                                                                                                                        
 `<nagios-password>`                        | This parameter defines the password used to log in to the monitoring server.                                                                                                                                        
 `<icinga2-show>`                           | This parameter defines whether Icinga2 monitoring should be displayed.                                                                                                                                              
 `<icinga2-host>`                           | This parameter specifies the Icinga2 monitoring server host from which the monitoring information should be retrieved.                                                                                              
 `<icinga2-username>`                       | This parameter defines the username used to log in to the monitoring server.                                                                                                                                        
 `<icinga2-password>`                       | This parameter defines the password used to log in to the monitoring server.                                                                                                                                        
 ...
 `<statistics-timerange-months>`            | This parameter specifies how many months of data should be displayed in the statistics chart. Use `0` to show all available data, or a positive integer to limit the timeframe (e.g., `24` for the last 24 months). 
