		...
		Thread nagiosThread = new Thread(new Runnable() {
			public void run() {
				...
				for (int i = 0; i <= numberOfHosts; i++) {
					...
					String serverURL = "http://monitoring.intranda.com/icinga/cgi-bin/status.cgi?host=" + url
							+ "&jsonoutput";
					String json = HttpClientHelper.getStringFromUrl(serverURL, serverLogin, serverPassword,
							"monitoring.intranda.com", "80");
					Gson gson = new Gson();
